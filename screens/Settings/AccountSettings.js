    ...
    return(
        <SafeAreaView style={{
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.textStyle}>Always maintain the most recent information available so that you can easily open and restore your account if it is lost.</Text>    
                <View style={{flex:1,marginTop:10}}>
                    <TouchableOpacity  onPress={() => navigation.navigate('PersonalDetails')} style={styles.buttonContainer}>
                   ...
                   <TouchableOpacity onPress={()=> navigation.navigate('UpdatePassword')} style={styles.buttonContainer}>
                       <View style={styles.buttonColumn}>
